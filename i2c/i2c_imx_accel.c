                        ...
                        const struct i2c_device_id *id)
{
    ...
    dev_info(&client->dev, "Entered my_probe().\n");
    ...
    i2c_smbus_write_byte_data(client, 0x31, 0x0b);
    i2c_smbus_write_byte_data(client, 0x2c, 0x08);
    i2c_smbus_write_byte_data(client, POWER_CTL, PCTL_MEASURE);
    i2c_smbus_write_byte_data(client, 0x2e, 0x80);
    i2c_smbus_write_byte_data(client, 0x1e, 0x00);
    i2c_smbus_write_byte_data(client, 0x1f, 0x00);
    i2c_smbus_write_byte_data(client, 0x20, 0x05);
...
MODULE_DESCRIPTION("i2c adxl345 accel");
